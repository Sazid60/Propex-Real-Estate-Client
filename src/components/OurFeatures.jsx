                ...
                <div className="flex flex-col justify-center items-center xl:flex-row lg:gap-4">
                    ...
                    <div className="w-full xl:w-1/2">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8 mt-4 xl:mt-12 xl:gap-12">
                            <div className="p-6 rounded-xl transition-all duration-500 border-2 border-transparent hover:border-blue-400 hover:shadow-[0_0_10px_3px_rgba(30,144,255,0.4)]">
                                <div className="md:flex flex-col justify-center items-center md:-mx-4">
                                    <span className="inline-block p-2 rounded-xl md:mx-4 text-4xl">
                                        <FaPersonCircleCheck />
                                    </span>
                                    <div className="mt-2 lg:mt-4 md:mx-4 md:mt-0">
                                        <h1 className="text-sm lg:text-xl font-medium text-gray-700 capitalize">
