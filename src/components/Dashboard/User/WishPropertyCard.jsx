...
const WishPropertyCard = ({ wished_property, handleDelete }) => {
    const { _id, title, location, propertyImage, agentName, agentImage, agentEmail, maxPrice, minPrice, verification_status, description,
        propertyId } = wished_property
    return (
                    ...
                    <div className="flex flex-col items-center xl:flex-row xl:justify-between">
                        ...
                        <div className="flex flex-col w-full xl:w-auto">
                            ...
                            <button
                                ...
                                className="btn btn-sm bg-red-600 text-white w-full font-semibold">Remove</button>
                        </div>
                    </div>
                </div>
            </div>
