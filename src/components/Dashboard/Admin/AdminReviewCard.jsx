...
const AdminReviewCard = ({ single_review, handleDeleteReview }) => {
    ...
    return (
        <div className="container shadow-lg flex flex-col w-full max-w-lg p-3 xl:p-2 mx-auto divide-y rounded-md dark:divide-gray-300  dark:text-gray-500">
        <div className="flex justify-between ">
            <div className="flex space-x-4">
                ...
                <div>
                    <h4 className="font-bold text-left text-xs md:text-xs xl:text-lg whitespace-nowrap">{reviewerName}</h4>
        ...
        <div className="p-3 space-y-2 text-sm dark:text-gray-600 text-center flex flex-col h-28 ">
            <p className="font-bold uppercase text-xs md:text-xs lg:text-xs xl:text-lg "><span className="text-blue-700">{reviewedPropertyName}</span></p>
            <p className="text-xs md:text-xs lg:text-sm xl:text-sm flex-grow ">
